...
// in fixmate/test/unit/services/chat_service_test.dart.
...
class MockXFile extends _i1.Mock implements _i11.XFile {
  ...
  @override
  _i5.Future<_i9.Uint8List> readAsBytes() => (super.noSuchMethod(
        Invocation.method(
          #readAsBytes,
          [],
        ),
  ...
  @override
  _i5.Stream<_i9.Uint8List> openRead([
    int? start,
    int? end,
  ]) =>
      (super.noSuchMethod(
  ...
  _i5.Future<DateTime> lastModified() => (super.noSuchMethod(
        ...
        returnValue: _i5.Future<DateTime>.value(_FakeDateTime_21(
          this,
          Invocation.method(
            #lastModified,
            [],
