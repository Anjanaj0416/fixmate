...
// MODIFIED: Removed Submit Request button, activated "Confirm & Get Quotes"
...
class _ServiceRequestFlowState extends State<ServiceRequestFlow> {
  ...
  Widget _buildStepContent() {
    switch (_currentStep) {
      ...
      case 1:
        return _buildProblemDetailsStep();
      case 2:
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 24),
          ...issueTypes.map((type) => _buildRadioOption(
                type['label']!,
                type['value']!,
                _selectedIssueType,
  ...
  Widget _buildProblemDetailsStep() {
    List<Map<String, String>> locationOptions = _getLocationOptions();
      ...
      child: Column(
        ...
        children: [
          ...
          if (widget.serviceType == 'plumbing') ...[
            ...
            SizedBox(height: 12),
            _buildRadioOption('Still working', 'working', _waterSupplyStatus,
                (value) => setState(() => _waterSupplyStatus = value)),
            _buildRadioOption('Not working', 'not_working', _waterSupplyStatus,
                (value) => setState(() => _waterSupplyStatus = value)),
            _buildRadioOption(
                'Partially working',
                'partial',
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoBox(),
          SizedBox(height: 24),
          // ✅ MODIFIED: This button now creates quotes instead of bookings
          SizedBox(
            width: double.infinity,
            height: 50,
            child: ElevatedButton(
              onPressed: _canProceed() ? _confirmAndGetQuotes : null,
        ...
        children: [
          ...
          Expanded(
            child: ElevatedButton(
              ...
              child: Text(
                _currentStep < _totalSteps - 1 ? 'Next' : 'Review',
                style: TextStyle(
                  color: Colors.white,
                  fontWeight: FontWeight.w600,
                ),
  ...
  // ✅ NEW METHOD: Navigate to worker selection (creates quote, not booking)
  Future<void> _confirmAndGetQuotes() async {
    ...
    try {
      ...
      if (_selectedImages.isNotEmpty) {
        ...
        for (int i = 0; i < _selectedImages.length; i++) {
          try {
            XFile xFile = XFile(_selectedImages[i].path);
      ...
      // The quote will be created after worker is selected
      Navigator.push(
        context,
        MaterialPageRoute(
      ...
      print('❌ Error in _confirmAndGetQuotes: $e');
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          action: SnackBarAction(
            ...
            onPressed: () => _confirmAndGetQuotes(),
          ),
        ),
      );
    } finally {
